# Arsitektur Baru (LightGBM & SHAP)

Berikut adalah flow arsitektur yang telah diperbarui dengan menambahkan layer **Machine Learning (LightGBM & SHAP)** untuk prediksi dan penjelasan klasifikasi risiko, namun tanpa disertai source code implementasinya (hanya sebatas diagram arsitektur).
...
flowchart TD
    ...
    subgraph ML["7. Machine Learning (LightGBM & SHAP)"]
        ML1["LightGBM Model\nPrediksi Tingkat Risiko / Anomali"]
        ML2["SHAP Explainer\nAnalisis Kontribusi\nFitur & Titik Kritis (CP)"]
    end

    F5 -->|"Data Klasifikasi Risiko\n& Data Historis"| ML1
    ML1 --> ML2
    ...
    style ML1 fill:#d35400,color:#fff
    style ML2 fill:#d35400,color:#fff
