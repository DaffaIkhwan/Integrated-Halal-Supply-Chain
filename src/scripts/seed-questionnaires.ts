...
async function main() {
  ...
  const RISIKO_DATA = [
    ...
    { cpId: 'CP4', respondentName: 'H. Zainal Arifin, S.Pt., M.Si.', respondentRole: 'Juru Sembelih Halal', respondentOrg: 'RPH Syariah Al-Anam Bogor', noSertifikat: 'JULEHA-2022-112', subCodes: ['CP4.1','CP4.2','CP4.3','CP4.4','CP4.5','CP4.6','CP4.7','CP4.8','CP4.9'], baseRisk: 1, bgData: { namaRPH: 'RPH Syariah Al-Anam', alamat: 'Jl. RPH Cibinong, Bogor', noSertifikat: 'JULEHA-2022-112', posisi: 'Juru Sembelih Halal', tanggal: '2026-05-14' } },
    { cpId: 'CP5', respondentName: 'Ir. Dewi Kusumawati', respondentRole: 'QC Supervisor', respondentOrg: 'RPH Syariah Al-Anam Bogor', noSertifikat: 'QC-2024-033', subCodes: ['CP5.1','CP5.2','CP5.3','CP5.4'], baseRisk: 2, bgData: { namaRPH: 'RPH Syariah Al-Anam', noSertifikat: 'QC-2024-033', posisi: 'QC Supervisor', tanggal: '2026-05-14' } },
    { cpId: 'CP6', respondentName: 'Bpk. Rudi Hartono, S.T.P.', respondentRole: 'Supervisor Produksi', respondentOrg: 'PT. Olahan Halal Nusantara', noSertifikat: 'PROC-2023-076', subCodes: ['CP6.1','CP6.2','CP6.3','CP6.4'], baseRisk: 2, bgData: { namaPerusahaan: 'PT. Olahan Halal Nusantara', lokasi: 'Cikarang, Bekasi', noSertifikat: 'PROC-2023-076', posisi: 'Supervisor Produksi', tanggal: '2026-05-14' } },
    { cpId: 'CP7', respondentName: 'Ibu Rina Marlina, A.Md.', respondentRole: 'Warehouse Supervisor', respondentOrg: 'PT. Cold Chain Halal Indonesia', noSertifikat: 'WH-2024-021', subCodes: ['CP7.1','CP7.2','CP7.3','CP7.4','CP7.5','CP7.6','CP7.7'], baseRisk: 2, bgData: { namaGudang: 'Cold Storage Halal 1', lokasi: 'Cilincing, Jakarta Utara', noSertifikat: 'WH-2024-021', posisi: 'Warehouse Supervisor', tanggal: '2026-05-14' } },
    { cpId: 'CP8', respondentName: 'Bpk. Faisal Rahman, S.E.', respondentRole: 'Logistics Manager', respondentOrg: 'PT. Distribusi Halal Sejahtera', noSertifikat: 'LOG-2023-099', subCodes: ['CP8.1','CP8.2','CP8.3','CP8.4','CP8.5','CP8.6','CP8.7'], baseRisk: 3, bgData: { namaPerusahaan: 'PT. Distribusi Halal Sejahtera', noSertifikat: 'LOG-2023-099', posisi: 'Logistics Manager', tanggal: '2026-05-14' } },
    { cpId: 'CP9', respondentName: 'Ibu Sri Wahyuni, S.E.', respondentRole: 'QC Retail', respondentOrg: 'Supermarket HalalMart Bandung', noSertifikat: 'RET-2024-055', subCodes: ['CP9.1','CP9.2','CP9.3','CP9.4','CP9.5','CP9.6','CP9.7'], baseRisk: 2, bgData: { namaOutlet: 'HalalMart Bandung', lokasi: 'Jl. Dago No. 45, Bandung', noSertifikat: 'RET-2024-055', posisi: 'QC Retail', tanggal: '2026-05-14' } },
  ];
  ...
  const AKTUAL_DATA = [
    { cpId: 'CP1', name: 'Pak Eko Prasetyo', role: 'Supervisor', org: 'Peternakan Berkah Mandiri', subCodes: ['CP1.1','CP1.2','CP1.3','CP1.4','CP1.5'], baseRisk: 2, bgData: { namaFarm: 'Peternakan Berkah Mandiri', lokasi: 'Lembang, Jawa Barat', namaStaff: 'Pak Eko Prasetyo', jabatan: 'Supervisor', tanggal: '2026-05-14', shift: 'Pagi', batch: 'BATCH-A2026-001' } },
    { cpId: 'CP2', name: 'drh. Maya Indrawati', role: 'Veteriner', org: 'Peternakan Berkah Mandiri', subCodes: ['CP2.1','CP2.2','CP2.3','CP2.4','CP2.5'], baseRisk: 2, bgData: { namaFarm: 'Peternakan Berkah Mandiri', lokasi: 'Lembang, Jawa Barat', namaPIC: 'drh. Maya Indrawati', jabatan: 'Veteriner', tanggal: '2026-05-14', shift: 'Pagi', batch: 'BATCH-A2026-001' } },
    { cpId: 'CP3', name: 'Bpk. Sugiono', role: 'Supervisor', org: 'PT. Ternak Angkut Sejahtera', subCodes: ['CP3.1','CP3.2','CP3.3','CP3.4','CP3.5'], baseRisk: 3, bgData: { namaPerusahaan: 'PT. Ternak Angkut Sejahtera', nomorKendaraan: 'B 1234 XYZ', namaPIC: 'Bpk. Sugiono', jabatan: 'Supervisor', tanggal: '2026-05-14', waktuBerangkat: '06:00', lokasiAsal: 'Lembang, Jawa Barat', lokasiTujuan: 'RPH Al-Anam, Bogor', batch: 'BATCH-A2026-001', jumlahHewan: '12' } },
    { cpId: 'CP4', name: 'H. Zainal Arifin', role: 'Juru Sembelih Halal', org: 'RPH Syariah Al-Anam', subCodes: ['CP4.1','CP4.2','CP4.3','CP4.4','CP4.5','CP4.6','CP4.7','CP4.8','CP4.9'], baseRisk: 1, bgData: { namaRPH: 'RPH Syariah Al-Anam', nomorSertifikat: 'RPH-HALAL-2023-001', masaBerlaku: '2025-12-31', alamat: 'Jl. RPH Cibinong, Bogor', namaPIC: 'H. Zainal Arifin', jabatan: 'Juru Sembelih Halal', idKaryawan: 'EMP-RPH-001', tanggal: '2026-05-14', shift: 'Pagi', waktuMulai: '05:30', batch: 'BATCH-A2026-001', jumlahHewan: '12', asalHewan: 'Peternakan Berkah Mandiri, Lembang', kendaraan: 'B 1234 XYZ', supplier: 'Peternakan Berkah Mandiri' } },
    { cpId: 'CP5', name: 'Ir. Dewi Kusumawati', role: 'QC Supervisor', org: 'RPH Syariah Al-Anam', subCodes: ['CP5.1','CP5.2','CP5.3','CP5.4'], baseRisk: 2, bgData: { namaRPH: 'RPH Syariah Al-Anam', nomorSertifikat: 'RPH-HALAL-2023-001', masaBerlaku: '2025-12-31', alamat: 'Jl. RPH Cibinong, Bogor', namaPIC: 'Ir. Dewi Kusumawati', jabatan: 'QC Supervisor', idKaryawan: 'EMP-RPH-002', tanggal: '2026-05-14', shift: 'Pagi', waktuMulai: '07:30', batch: 'BATCH-A2026-001' } },
    { cpId: 'CP6', name: 'Bpk. Rudi Hartono', role: 'Supervisor Produksi', org: 'PT. Olahan Halal Nusantara', subCodes: ['CP6.1','CP6.2','CP6.3','CP6.4'], baseRisk: 2, bgData: { namaPerusahaan: 'PT. Olahan Halal Nusantara', lokasi: 'Cikarang, Bekasi', namaPIC: 'Bpk. Rudi Hartono', jabatan: 'Supervisor Produksi', idKaryawan: 'EMP-PROC-001', tanggal: '2026-05-14', shift: 'Siang', waktuMulai: '08:00', batch: 'BATCH-A2026-001', namaProduk: 'Daging Sapi Halal Segar', jenisProduk: 'Fresh Meat', jumlahProduk: '500' } },
    { cpId: 'CP7', name: 'Ibu Rina Marlina', role: 'Warehouse Supervisor', org: 'PT. Cold Chain Halal Indonesia', subCodes: ['CP7.1','CP7.2','CP7.3','CP7.4','CP7.5','CP7.6','CP7.7'], baseRisk: 2, bgData: { namaGudang: 'Cold Storage Halal Unit 1', lokasi: 'Cilincing, Jakarta Utara', namaPIC: 'Ibu Rina Marlina', jabatan: 'Warehouse Supervisor', idKaryawan: 'EMP-WH-001', tanggal: '2026-05-14', shift: 'Pagi', suhuAwal: '-2', suhuAkhir: '-4', batch: 'BATCH-A2026-001' } },
    { cpId: 'CP8', name: 'Bpk. Faisal Rahman', role: 'Logistics Manager', org: 'PT. Distribusi Halal Sejahtera', subCodes: ['CP8.1','CP8.2','CP8.3','CP8.4','CP8.5','CP8.6','CP8.7'], baseRisk: 3, bgData: { namaPerusahaan: 'PT. Distribusi Halal Sejahtera', lokasi: 'Jakarta Timur', namaPIC: 'Bpk. Faisal Rahman', jabatan: 'Logistics Manager', idKaryawan: 'EMP-LOG-001', tanggal: '2026-05-14', shift: 'Pagi', nomorKendaraan: 'B 5678 ABC', tujuanDistribusi: 'HalalMart Bandung, Jabodetabek', batch: 'BATCH-A2026-001' } },
    { cpId: 'CP9', name: 'Ibu Sri Wahyuni', role: 'QC Retail', org: 'HalalMart Bandung', subCodes: ['CP9.1','CP9.2','CP9.3','CP9.4','CP9.5','CP9.6','CP9.7'], baseRisk: 2, bgData: { namaOutlet: 'HalalMart Bandung — Dago', lokasi: 'Jl. Dago No. 45, Bandung', namaPIC: 'Ibu Sri Wahyuni', jabatan: 'QC Retail', idKaryawan: 'EMP-RET-001', tanggal: '2026-05-14', shift: 'Pagi', batch: 'BATCH-A2026-001' } },
  ];
