...
import { CP6_OPTIONS, CP7_OPTIONS, CP8_OPTIONS, CP9_OPTIONS } from "./cp-options-6-10";

export {
  CP1_OPTIONS, CP2_OPTIONS, CP3_OPTIONS, CP4_OPTIONS, CP5_OPTIONS,
  CP6_OPTIONS, CP7_OPTIONS, CP8_OPTIONS, CP9_OPTIONS,
};
...
export const CP_OPTIONS_MAP: Record<string, typeof CP1_OPTIONS> = {
  ...
  CP6: CP6_OPTIONS, CP7: CP7_OPTIONS, CP8: CP8_OPTIONS, CP9: CP9_OPTIONS,
};
